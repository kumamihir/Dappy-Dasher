...
# Set this to your actual raylib path
...
INCLUDE_PATHS += -IC:/raylib/raylib/src -IC:/raylib/raylib/src/external
...
LDFLAGS = -L. -LC:/raylib/raylib/src -LC:/raylib/raylib/lib
...
$(PROJECT_NAME): $(OBJS)
    $(CC) -o output/$(PROJECT_NAME).exe $(OBJS) $(CFLAGS) $(INCLUDE_PATHS) $(LDFLAGS) $(LDLIBS) -D$(PLATFORM)
